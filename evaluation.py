            ...
            for i in range(len(uncleaned_relation)):
                if '\t' in uncleaned_relation[i]:
                    ...
                    if i+1 < len(uncleaned_relation):
                        intent+=uncleaned_relation[i:]
                    intents.append(intent)
                    uncleaned_relations[index] = uncleaned_relation[:i]
                    break
...
if __name__ == '__main__':
    ...
    y_true, y_true_intents = opener('hw2_tags_test.txt') if args.test else opener('hw2_labels_dev.txt')
    y_pred, y_pred_intents = opener('predictions.txt') if args.test else opener('prediction_dev.txt')
